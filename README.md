...
- `--permissive` — Warn and continue without mount namespace isolation if it cannot be established. This is the default on macOS, where mount namespaces are not available. Seccomp and other layers still provide defense.
